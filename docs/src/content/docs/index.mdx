...
| Section | Description |
|---------|-------------|
| [Architecture](/infra-advisor-ai/architecture/) | System design, service map, data flow |
| [Services](/infra-advisor-ai/services/) | API reference for each microservice |
| [Data Pipeline](/infra-advisor-ai/data-pipeline/) | Airflow DAGs and ingestion details |
| [Observability](/infra-advisor-ai/observability/) | Datadog instrumentation across every layer |
| [Deployment](/infra-advisor-ai/deployment/) | Prerequisites, secrets, step-by-step deploy |
| [Development](/infra-advisor-ai/development/) | Local setup, testing, conventions |
